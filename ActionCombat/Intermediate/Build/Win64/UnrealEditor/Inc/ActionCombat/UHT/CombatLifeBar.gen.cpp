...
ACTIONCOMBAT_API UClass* Z_Construct_UClass_UCombatLifeBar();
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UCombatLifeBar_SetBarColor_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UCombatLifeBar, nullptr, "SetBarColor", 	Z_Construct_UFunction_UCombatLifeBar_SetBarColor_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_UCombatLifeBar_SetBarColor_Statics::PropPointers), 
sizeof(CombatLifeBar_eventSetBarColor_Parms),
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08820800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCombatLifeBar_SetBarColor_Statics::Function_MetaDataParams), Z_Construct_UFunction_UCombatLifeBar_SetBarColor_Statics::Function_MetaDataParams)},  };
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UCombatLifeBar_SetLifePercentage_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UCombatLifeBar, nullptr, "SetLifePercentage", 	Z_Construct_UFunction_UCombatLifeBar_SetLifePercentage_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_UCombatLifeBar_SetLifePercentage_Statics::PropPointers), 
sizeof(CombatLifeBar_eventSetLifePercentage_Parms),
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCombatLifeBar_SetLifePercentage_Statics::Function_MetaDataParams), Z_Construct_UFunction_UCombatLifeBar_SetLifePercentage_Statics::Function_MetaDataParams)},  };
...
// ********** End Class UCombatLifeBar constinit property declarations *****************************
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UCombatLifeBar_SetBarColor, "SetBarColor" }, // 3333359732
		{ &Z_Construct_UFunction_UCombatLifeBar_SetLifePercentage, "SetLifePercentage" }, // 293327221
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_User_Desktop_Project_UE5_ActionCombatPortfolio_ActionCombat_Source_ActionCombat_Variant_Combat_UI_CombatLifeBar_h__Script_ActionCombat_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UCombatLifeBar, UCombatLifeBar::StaticClass, TEXT("UCombatLifeBar"), &Z_Registration_Info_UClass_UCombatLifeBar, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCombatLifeBar), 318193286U) },
	};
}; // Z_CompiledInDeferFile_FID_Users_User_Desktop_Project_UE5_ActionCombatPortfolio_ActionCombat_Source_ActionCombat_Variant_Combat_UI_CombatLifeBar_h__Script_ActionCombat_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_User_Desktop_Project_UE5_ActionCombatPortfolio_ActionCombat_Source_ActionCombat_Variant_Combat_UI_CombatLifeBar_h__Script_ActionCombat_1628486989{
	TEXT("/Script/ActionCombat"),
	Z_CompiledInDeferFile_FID_Users_User_Desktop_Project_UE5_ActionCombatPortfolio_ActionCombat_Source_ActionCombat_Variant_Combat_UI_CombatLifeBar_h__Script_ActionCombat_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_User_Desktop_Project_UE5_ActionCombatPortfolio_ActionCombat_Source_ActionCombat_Variant_Combat_UI_CombatLifeBar_h__Script_ActionCombat_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
